                                ...
                                >
                                    ...
                                    <td class="px-2 py-4 align-top">
                                        <input
                                            ...
                                            required
                                            inputmode="numeric"
                                            class="input-underline h-9 px-1 text-right font-semibold"
                                        />
                                    ...
                                    <td class="px-2 py-4 align-top">
                                        <input
                                            ...
                                            :max="r.sisa_qty"
                                            inputmode="decimal"
                                            class="input-underline input-emerald h-9 px-1 text-right font-bold"
                                        />
                                    </td>
                                    ...
                                    <td class="px-2 py-4 align-top">
                                        <input
                                            ...
                                            step="0.001"
                                            inputmode="decimal"
                                            class="input-underline input-rose h-9 px-1 text-right font-bold"
                                        />
                                    </td>
                                ...
                                >
                                    <div class="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            required
                                            inputmode="numeric"
                                            class="input-underline h-11 px-1 text-right font-bold"
                                        />
                                    </div>
                                ...
                                <div class="grid grid-cols-2 gap-3">
                                    <div class="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            :max="r.sisa_qty"
                                            inputmode="decimal"
                                            class="input-underline input-emerald h-12 px-1 text-right font-black"
                                        />
                                    </div>
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <input
                                            ...
                                            step="0.001"
                                            inputmode="decimal"
                                            class="input-underline input-rose h-12 px-1 text-right font-black"
                                        />
                                    </div>
                                </div>
                                ...
                                <transition name="slide-fade">
                                    ...
                                    >
                                        ...
                                        <textarea
                                            ...
                                            class="input-underline input-rose px-1 py-2.5 resize-none"
                                        ></textarea>
                                    </div>
                                </transition>
                            </div>
