<template>
    <div class="relative flex h-screen w-full overflow-hidden bg-[#F8FAFC] font-sans text-slate-700">
        ...
        <div
            ...
            @click="tutupDiMobile"
            class="fixed inset-0 z-[998] bg-slate-950/45 backdrop-blur-[2px]"
            role="presentation"
            aria-hidden="true"
        ></div>
        ...
        <aside
            ...
            class="fixed bottom-2 left-2 top-2 z-[999] flex w-[88px] flex-col items-center justify-between rounded-3xl border border-slate-100 bg-white/95 py-6 shadow-[0_12px_40px_rgba(15,23,42,0.08)] backdrop-blur-xl transition-transform duration-300 ease-out"
            :class="
                sidebarAktif
                    ? 'translate-x-0'
                    : '-translate-x-[150%]'
            ...
            role="dialog"
            aria-modal="true"
            aria-labelledby="transaction-sidebar-title"
        ...
        >
            ...
            <div class="flex w-full flex-col items-center gap-7">
                ...
                >
                    ...
                    >
                        <span
                            class="absolute -left-1 top-1/2 h-6 w-1 -translate-y-1/2 rounded-full"
                            :class="
                                aktif(menu.rute)
