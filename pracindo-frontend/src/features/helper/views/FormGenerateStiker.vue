<template>
  <div v-if="hurufAktif" id="form-input-stiker" class="p-4 sm:p-6 bg-white border border-gray-200 shadow-xl rounded-2xl transition-all duration-300">
...
const { hurufAktif, formData, tutupForm, simpanNamaTampil } = useStiker()
