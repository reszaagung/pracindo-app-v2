...
/* --- Variasi Warna Ungu/Violet (D) --- */
.box-d {
  background: linear-gradient(135deg, #b224ef 0%, #7579ff 100%);
  box-shadow: 0 10px 20px rgba(178, 36, 239, 0.3), 
              inset 0 -3px 0 rgba(0, 0, 0, 0.1);
}
.box-d:hover {
  box-shadow: 0 15px 25px rgba(178, 36, 239, 0.4), 
              inset 0 -3px 0 rgba(0, 0, 0, 0.1);
}
</style>