...
import {
    akuntingModul,
    bukuTagihanModul,
} from '@/features/accounting/uiConfigAccounting'
import {
    gudangModul,
    distribusiModul,
} from '@/features/warehouse/uiConfigWarehouse'
import {
    inventoryModul,
} from '@/features/inventory/uiConfigInventory'
...
export const cariModul = (id) =>
    MODUL.find((m) => m.id === id) ?? null
...
export const modulDariBackend = (modulBackend = []) =>
    modulBackend.map((mb) => {
        ...
        return {
            ...
            sembunyiDiDashboardUntuk:
                lokal?.sembunyiDiDashboardUntuk || [],
            sembunyiDiDashboard:
                lokal?.sembunyiDiDashboard || false,
            menu: lokal?.menu ?? [],
        }
    })
...
export const IKON = {
    ...
    gudang:
        '<path d="M3 9l9-5 9 5v11H3z"/><path d="M8 20v-7h8v7"/>',
    produksi:
        '<path d="M4 20V9l5 3V9l5 3V6l6 4v10z"/><path d="M4 20h16"/>',
    kirim:
        '<path d="M2 7h11v9H2zM13 10h4l3 3v3h-7z"/><circle cx="6" cy="18" r="2"/><circle cx="17" cy="18" r="2"/>',
    master:
